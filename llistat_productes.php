...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <table class="table">
            <tr>
            <br>
        <h1 class="h3 mb-0 text-gray-800">Llistat de productes</h1>
        <br>
                <th>Nom del producte</th><th>Genere</th><th>Proveidor</th>
            </tr> <?php
            while($producte=mysqli_fetch_array($result)) { ?>
                <tr>
                    ...
                    <td>
                        <a class="button-white button-block-editar as-tradeupinline-button" href="modificar_producte.php?usuari=<?php echo $producte["id_producte"];?>">Editar</a>
                        <a class="button-white button-block-eliminar as-tradeupinline-button" href="functions/eliminar_producte.php?usuari=<?php echo $producte["id_producte"];?>">Eliminar</a>
                    </td>
                </tr><?php
        } ?>
        </table>
