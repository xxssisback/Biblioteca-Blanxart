    ...
    <div class="recuadro_lista">
        <div>
            <table class="table">
                <tr>
                <br>
        <h1 class="h3 mb-0 text-gray-800">Llistat de vendes</h1>
        <br>
                    <th>Client</th><th>Producte venut</th><th>Genere</th><th>Proveidor</th><th>Quantitat</th><th>Pagament</th>
                </tr> <?php
                while($producte=mysqli_fetch_array($result)) { ?>
                    <tr>
                        <td><?php echo $producte["nom_i_cognom"]; ?></td>          
                        <td><?php echo $producte["nom"]; ?></td>
                        <td><?php echo $producte["genere"]; ?></td>
                        <td><?php echo $producte["proveidor"]; ?></td>
                        <td><?php echo $producte["quantitat"]; ?></td>
                        <td><?php echo $producte["preu"]; ?></td>
                        <td>
                            <a class="button-white button-block-editar as-tradeupinline-button" href="modificar_venda.php?usuari=<?php echo $producte["id_operacio"];?>">Editar</a>
                            <a class="button-white button-block-eliminar as-tradeupinline-button" href="functions/eliminar_venda.php?usuari=<?php echo $producte["id_operacio"];?>">Eliminar</a>
                        </td>
                    </tr><?php
            } ?>
            </table>
