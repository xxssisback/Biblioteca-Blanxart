...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <h1 class="nou-usuari">Nou producte</h1>
        <hr>
        <form action=functions/gravar_producte.php method="POST">
            <label for=nom>Nom del producte: </label>
            <input class="form-textbox form-textbox-text" type="text" id=nom name=nom size="20"><br><br>
            <label for=genere>Genere: </label>
            <select class="form-textbox form-textbox-text" id=genere name=genere>
            ...
            <input class="form-textbox form-textbox-text" type="text" id=proveidor name=proveidor size="40"><hr>
            <div align="center">
